            ...
            <div class="container">
                <form class="form-horizontal" id="moveform" role="form"action="confirm.php" method="GET" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" id="name" name="name" placeholder="Dogs Name" class="form-control" autofocus required pattern="[a-z]{1-20)">
                        </div>
                    </div>
                    <div class="form-group">
                        <label for="phoneNumber" class="col-sm-3 control-label">מספר ציפ אלקטרוני </label>
                        <div class="col-sm-9">
                            <input type="phoneNumber" id="phoneNumber" name="chipId" placeholder="הזן מס' בן 15 ספרות" class="form-control"  required pattern="[0-9]{15)">
                            ...
                            <div class="row">
                                <div class="col-sm-4">
                                    <label class="radio-inline">
                                        <input type="radio"  name="gender" id="femaleRadio" value="Female" required>נקבה
                                    </label>
                                </div>
                                <div class="col-sm-4">
                                    <label class="radio-inline">
                                        <input type="radio"  name="gender" id="maleRadio" value="Male" required>זכר
                                    </label>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="form-group">
                        <label for="Height" class="col-sm-3 control-label">התנהגות קיימת </label>
                        <div class="bg">
                            <div class="custom-control custom-checkbox" id="input3">
                                <input type="checkbox" class="custom-control-input" id="defaultChecked2" checked>
                                <label class="custom-control-label" for="defaultChecked2">תוקפנות</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultChecked2" checked>
                                <label class="custom-control-label" for="defaultChecked2">הריסת חפצים</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultChecked2" checked>
                                <label class="custom-control-label" for="defaultChecked2">יללות ונביחות</label>
                            </div>
                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultChecked2" checked>
                                <label class="custom-control-label" for="defaultChecked2">צרכים בבית</label>
                            </div>

                            <div class="custom-control custom-checkbox">
                                <input type="checkbox" class="custom-control-input" id="defaultChecked2" checked>
                                <label class="custom-control-label" for="defaultChecked2">חוצפן</label>
                            </div>   
                        </div>
                    </div>
                    ...
                    <button type="submit" class="btn btn-primary btn-block">שמור</button>
                </form> <!-- /form -->
            </div> <!-- ./container -->
